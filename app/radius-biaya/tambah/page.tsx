...
import { createSkRadiusBiaya, type SkRadiusBiaya } from '@/lib/api';
...
function SkRadiusBiayaForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await createSkRadiusBiaya(dataToSend);
            if (result.success) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Formulir SK Radius Biaya</CardTitle>
                <CardDescription>
                    Tambahkan Surat Keputusan Panjar Biaya Perkara.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                        ...
                        />
                        <p className='text-xs text-muted-foreground'>
                            JSON metadata berisi dasar hukum, klasifikasi radius, dan komponen panjar biaya. Bisa dikosongkan.
                        </p>
                    </div>
...
export default function SkRadiusBiayaTambah() {
    return (
        <div className='max-w-2xl mx-auto space-y-6'>
            <BlurFade delay={0.1} inView>
                <div className='flex items-center gap-4'>
                    <Link href='/radius-biaya'><Button variant='outline' size='icon'><ArrowLeft className='h-4 w-4' /></Button></Link>
                    <h2 className='text-2xl font-bold tracking-tight'>Tambah SK Radius Biaya</h2>
                </div>
            </BlurFade>
